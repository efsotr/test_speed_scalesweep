...
run_benchmark \
  ...
  --no-enforce-eager \
  --output-dir output_cudagraph \
  --llm-kwargs-json '{"linear_backend":"cutlass","act_quant_backend":"cutlass","compilation_config":{"mode":3,"backend":"eager","cudagraph_mode":"PIECEWISE"}}'
...
#   --no-enforce-eager \
#   --output-dir output_cudagraph \
#   --llm-kwargs-json '{"linear_backend":"cutlass","act_quant_backend":"scalesweep_mse","compilation_config":{"mode":3,"backend":"eager","cudagraph_mode":"PIECEWISE"}}'
...
run_benchmark \
  ...
  --no-enforce-eager \
  --output-dir output_cudagraph \
  --llm-kwargs-json '{"linear_backend":"cutlass","act_quant_backend":"scalesweep","compilation_config":{"mode":3,"backend":"eager","cudagraph_mode":"PIECEWISE"}}'
